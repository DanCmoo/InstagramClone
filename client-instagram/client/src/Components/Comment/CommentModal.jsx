      ...
      <Modal size={"4xl"} onClose={handleClose} isOpen={isOpen} isCentered>
        ...
        <ModalContent className="bg-white dark:bg-gray-800">
          <ModalBody className="bg-white dark:bg-gray-800">
            <div className="flex h-[75vh] bg-white dark:bg-gray-800">
              ...
              <div className="w-[55%] pl-10 relative bg-white dark:bg-gray-800">
                <div className="reqUser flex justify-between items-center py-5">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <p className="text-black dark:text-gray-100">{post?.singlePost?.user?.name}</p>
                      <p className="text-black dark:text-gray-300">{post?.singlePost?.user?.username}</p>
                    </div>
                  </div>
                  <BsThreeDots className="text-black dark:text-gray-100"/>
                </div>
                ...
                <div className=" absolute bottom-0 w-[90%]">
                  ...
                  {post.singlePost?.likedByUsers?.length > 0 && (
                    <p className="text-sm font-semibold py-2">
                      {post.singlePost?.likedByUsers?.length} me gusta{" "}
                    </p>
                  )}
                  ...
                  <div className=" flex items-center ">
                    <BsEmojiSmile className="mr-3 text-xl text-black dark:text-gray-100" />
                    <input
                      className="commentInput w-[70%] bg-transparent text-black dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
