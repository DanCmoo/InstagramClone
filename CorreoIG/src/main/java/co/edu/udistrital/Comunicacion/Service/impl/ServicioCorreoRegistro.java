...
@Service
public class ServicioCorreoRegistro implements iServicioCorreo {
    ...
    public ServicioCorreoRegistro(JavaMailSender javaMailSender, TemplateEngine templateEngine) {
    ...
    public void enviarCorreo(ModeloCorreo correo) throws MessagingException {
        ...
        helper.setSubject("Registro exitoso"); // Establece el asunto del correo
        ...
        context.setVariable("timeRegistered",correo.getTimestamp());
