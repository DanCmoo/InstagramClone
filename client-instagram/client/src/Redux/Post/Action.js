...
import {
  ...
  UNLIKE_POST,
  UNSAVE_POST,
  UPDATE_USER_POSTS_PROFILE_IMAGE,
} from "./ActionType";
...
// Acción para actualizar la imagen de perfil del usuario en todas sus publicaciones
export const updateUserPostsProfileImage = (userId, newImage) => (dispatch) => {
  dispatch({
    type: UPDATE_USER_POSTS_PROFILE_IMAGE,
    payload: { userId, newImage }
  });
};
