import { FOLLOW_USER, UNFOLLOW_USER, GET_USERS_BY_USER_IDS, GET_USER_BY_USERNAME, GET_USER_PROFILE, SEARCH_USER, UPDATE_USER, LOGOUT } from "./ActionType"
...
export const userReducer=(store=initialState,{type,payload})=>{
    if(type===GET_USER_PROFILE){
        ...
        return initialState; // Reset user state on logout
    }
