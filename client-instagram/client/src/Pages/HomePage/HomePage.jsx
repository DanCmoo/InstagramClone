...
const HomePage = () => {
  ...
  // Función para manejar cambios en las sugerencias
  const handleSuggestionsChange = (updatedSuggestions) => {
    setSuggestedUser(updatedSuggestions);
  };
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
       ...
       <div className="mt-10 flex w-[100%] justify-center">
        <div className="flex flex-col w-[44%] px-10 items-center">
          {storyUsers.length> 0 && <div  className="flex space-x-2 border border-gray-200 dark:border-gray-700 p-4 rounded-md justify-start w-full mb-[3rem] bg-white dark:bg-gray-800">
